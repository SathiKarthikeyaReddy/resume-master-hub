  ...
  return (
    <div className="bg-white text-gray-900 min-h-[1123px] w-full max-w-[794px] mx-auto shadow-lg font-['Poppins',_sans-serif] text-sm">
      ...
      <div className="p-8">
        {summary && (
          <section className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white text-lg font-bold" style={{ background: `linear-gradient(135deg, ${accent}, ${accent}cc)` }}>✦</div>
        ...
        <div className="mt-6">
          <CertificationsBlock data={data} variant="creative" primaryColor={accent} />
          <ProjectsBlock data={data} variant="creative" primaryColor={accent} />
          <LanguagesBlock data={data} variant="creative" primaryColor={accent} />
          <VolunteerBlock data={data} variant="creative" primaryColor={accent} />
          <AwardsBlock data={data} variant="creative" primaryColor={accent} />
          <ReferencesBlock data={data} variant="creative" primaryColor={accent} />
